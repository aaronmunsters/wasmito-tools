...
export const __wbg_mappingincludingoffset_free: (a: number, b: number) => void;
export const __wbg_module_free: (a: number, b: number) => void;
export const __wbg_parseerror_free: (a: number, b: number) => void;
export const __wbg_positionedinstruction_free: (a: number, b: number) => void;
...
export const mappingincludingoffset_address: (a: number) => bigint;
export const mappingincludingoffset_column: (a: number) => number;
export const mappingincludingoffset_file: (a: number) => [number, number];
export const mappingincludingoffset_instructions: (a: number) => [number, number];
export const mappingincludingoffset_line: (a: number) => number;
export const mappingincludingoffset_range_size: (a: number) => bigint;
...
export const module_addr2line_mappings_with_offsets: (a: number) => [number, number, number, number];
...
export const positionedinstruction_address: (a: number) => number;
export const positionedinstruction_instr: (a: number) => [number, number];
